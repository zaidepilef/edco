...
El sitio SHALL aplicar una identidad visual coherente en todas las páginas: logotipo, paleta de colores, tipografías y tono de comunicación definidos para EDCO.
...
El sitio SHALL incluir una navegación principal que permita acceder a las secciones principales desde cualquier página. En móvil SHALL estar disponible una versión colapsable de la navegación.
